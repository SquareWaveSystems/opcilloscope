...
### Windows Build
- [ ] Build completes without errors: `dotnet build -c Release`
- [ ] Published executable runs: `dotnet publish -c Release -r win-x64`
- [ ] App launches from published folder
- [ ] `--help` displays correctly
- [ ] Connect to local OPC UA server succeeds
- [ ] Subscribe to variable and observe value updates
- [ ] Ctrl+Q exits cleanly
- [ ] No unhandled exceptions in console output

### Linux (WSL) Build
- [ ] Build completes without errors: `dotnet build -c Release`
- [ ] Published executable runs: `dotnet publish -c Release -r linux-x64`
- [ ] App launches from published folder
- [ ] Terminal.Gui renders correctly in WSL terminal
- [ ] `--help` displays correctly
- [ ] Connect to OPC UA server (use WSL IP or localhost)
- [ ] Subscribe to variable and observe value updates
...
- [ ] Config file created on Windows loads on Linux
- [ ] Config file created on Linux loads on Windows
- [ ] CSV recording produces valid output on both platforms
