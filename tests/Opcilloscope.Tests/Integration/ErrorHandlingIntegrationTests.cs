...
public class ErrorHandlingIntegrationTests : IntegrationTestBase
{
    ...
    {
        // Arrange
        var nodeBrowser = new Opcilloscope.OpcUa.NodeBrowser(Client!, _logger);
        var invalidNode = new Opcilloscope.OpcUa.Models.BrowsedNode
        {
    ...
    public async Task NodeBrowser_WhenDisconnected_ReturnsEmptyList()
    {
        ...
        var nodeBrowser = new Opcilloscope.OpcUa.NodeBrowser(disconnectedClient, _logger);
